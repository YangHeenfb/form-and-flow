...
describe('convolution module registry and URL params', () => {
  it('registers the convolution module once with all six ready routes', () => {
    ...
    expect(resolveRoute('/modules/convolution/probability').kind).toBe('explorer')
    expect(resolveRoute('/modules/convolution/signal').kind).toBe('explorer')
    expect(resolveRoute('/modules/convolution/image-kernel').kind).toBe('explorer')
    expect(resolveRoute('/modules/convolution/polynomial').kind).toBe('explorer')
